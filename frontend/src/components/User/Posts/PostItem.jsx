                    ...
                    <div className="flex flex-col justify-between border w-full max-w-xl rounded bg-white">
                        ...
                        <div className="p-4 w-full flex-1 max-h-[63vh] overscroll-x-hidden overflow-y-auto">
                            ...
                            <div className="flex flex-auto items-start space-x-1 mb-3.5">
                                <Link to={`/${postedBy.username}`}><img draggable="false" className="w-9 h-9 rounded-full object-cover mr-2.5" src={BASE_PROFILE_IMAGE_URL + postedBy.avatar} alt="avatar" /></Link>
